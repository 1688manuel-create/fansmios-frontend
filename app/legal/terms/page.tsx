        ...
        <div className="glass-panel bg-[#0a0a0a] border border-white/10 rounded-[2rem] p-8 sm:p-12 shadow-2xl">
          ...
          <div className="space-y-8 text-sm leading-relaxed font-medium">
            <section>
              ...
              <p>Al acceder y utilizar Fansmio VIP ("la Plataforma"), usted acepta estar sujeto a estos Términos de Servicio. Si no está de acuerdo con alguna parte de estos términos, tiene prohibido utilizar la Plataforma. Debe tener al menos 18 años de edad (o la mayoría de edad legal en su jurisdicción) para crear una cuenta.</p>
            </section>

            <section>
              <h2 className="text-xl font-black text-white mb-3">2. Creadores y Verificación KYC</h2>
              <p>Todo usuario que desee monetizar contenido ("Creador") debe someterse a un riguroso proceso de verificación de identidad (KYC - Know Your Customer) proporcionando una identificación gubernamental válida y una prueba de vida (reconocimiento facial biométrico). Fansmio mantiene una política de tolerancia cero frente al fraude, la trata de personas y el contenido no consensuado.</p>
            </section>

            <section>
              <h2 className="text-xl font-black text-white mb-3">3. Propiedad del Contenido (UGC)</h2>
              <p>
                <strong className="text-white">Fansmio VIP NO es propietario ni adquiere los derechos de propiedad intelectual del material subido por los Creadores.</strong> La plataforma actúa estricta y únicamente como un proveedor de servicios interactivos (intermediario tecnológico/hosting) para facilitar la distribución del contenido. 
              </p>
              <p className="mt-2">
                El Creador conserva en todo momento el 100% de la titularidad y responsabilidad legal de su obra. Al subir contenido, usted otorga a Fansmio únicamente una licencia técnica mundial, no exclusiva y libre de regalías para alojar, almacenar y mostrar dicho contenido en su nombre a los usuarios que hayan pagado por el acceso.
              </p>
            </section>
